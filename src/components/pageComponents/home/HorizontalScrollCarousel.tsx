...
const HorizontalScrollCarousel = ({
  ...
  return (
    <section
      ref={targetRef}
      className="relative h-[400vh] w-full bg-primary-default lg:block hidden"
    >
      <motion.div
        variants={reveal(4)}
        initial="hidden"
        ...
        >
          <div className="flex flex-col  justify-center items-start gap-8 h-[450px] xl:h-[85vh]  xl:w-[50vw]  ">
            <div className="text-left">
              <span className="text-7xl font-junge font-semibold text-secondary-dark">
                Food
              </span>
            </div>
            <div className="text-left pl-2">
              <span className="text-base xl:text-lg font-junge font-semibold text-secondary-dark ">
                Our menu is a celebration of global cuisine, inspired by the
                rich tapestry of cultures
                <br />
                from around the world. From the fiery flavors of Indian street
                food to the delicate
                <br /> artistry of Japanese sushi, our chefs expertly craft
                dishes that showcase the best
                <br />
    ...
    //         </div>
    //         <div className="text-left pl-2">
    //           <span className="text-base font-junge font-semibold text-secondary-dark ">
...
const Card = ({ card }: { card: CardType; setIsModalOpen: any }) => {
  return (
    <div
      key={card.id}
