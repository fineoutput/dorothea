...
const ScrollingText = () => {
  const social = [
    {
      platform: "Instagram",
      username: "@dorothea.jaipur",
      href: "https://instagram.com/dorothea.jaipur",
    },
  ];
  return (
    <div className="py-12 xl:pt-40 bg-gradient-dark">
      <div className=" overflow-x-hidden relative  ">
        ...
        <div className="flex justify-center items-center pt-8 ">
          <Link
            href={social[0].href}
            className="text-3xl border-b-2 border-white font-junge text-white"
          >
            {social[0].username}
          </Link>
        </div>
