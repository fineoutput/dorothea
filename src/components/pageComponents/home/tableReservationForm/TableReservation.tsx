...
function TableReservation({ setIsOpen }: any) {
  ...
  return (
    <div id="booking" className="   flex items-center justify-center">
      <div className="  flex gap-4 justify-center items-center w-full lg:max-w-full">
        <div className="flex flex-col justify-between  xl:p-6 xl:pt-0 w-full lg:min-w-[85%]">
          <div className="flex justify-between xl:-mt-2">
            <span className="text-left xl:text-center  w-full text-[1.5rem] md:text-[3rem] xl:text-[4rem] py-4  font-heading">
              RESERVE A TABLE
            </span>
            <button
              title="button"
